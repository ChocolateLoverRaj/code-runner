...
pub fn set_pixel_in(
    framebuffer: &mut TakeFrameBufferOutputData,
    position: Position,
    color: Rgb888,
) {
...
pub struct FrameBufferDisplay<'f> {
    framebuffer: &'f mut TakeFrameBufferOutputData,
}

impl FrameBufferDisplay<'_> {
    pub fn new(framebuffer: &mut TakeFrameBufferOutputData) -> FrameBufferDisplay {
